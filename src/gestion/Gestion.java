...
public class Gestion {
	/**
	 * REQUIERO LAS CONSULTAS DE BBDD
	 * FUNCIONA LA OPCION1, PERO SOLO CON ESPAÑA Y MADRID DE PRUEBA
	 * HASTA OBTENER EL RESULTADO DE LAS CONSULTAS
	 * */
	...
	/*ERROR DE REPETICION DE ESTE METODO AUNQUE SI COMPRUEBA LA CIUDAD
	 * POR RAZON DESCONOCIDA REPITE LA OPERACION 3 VECES,(NOTA: NO ME FUNCIONA EL BICHO DEPURAR)
	 * **/
	public boolean eligoCiudad(String ciudadOPais) {
		...
		try {
			...
			if(laCiudad.equalsIgnoreCase("Madrid")) {
				...
				System.out.println("La Ciudad que nos indicas no tiene el Aereopuerto 0 el nombre no es correcto activo solo las mostradas");
	...
	/*
	 * Este metodo comprueba si lo introducido es ciudad o pais, si es ciudad es correcto
	 * si es pais va al metodo eligoCiudad y lista las ciudades el que se debe elegir, ya que en un
	 * pais puede hacer 1 o mas aereopuertos, pero no todas las ciudades lo tienen
	 * 
	 * **/
	...
	public void precioVueloSoloIda(LocalDate fecha) {
		...
		Aerolinea [] Aereolineas = new Aerolinea[6];//Falta rellenar nombres de aereolineas
			...
			System.out.println("Desde el dia "+fecha.getDayOfMonth()+" de "+fecha.getMonth()+". Tenemos las siguientes opciones;\n");
	...
	//sOLO SE DEBE DEVOLVER EN UNA MATRIZ JUNTO CON LAS FECHAS DE SALIDA Y LLEGADA PERO LO DEMAS ES LO MISMO
